...
function checkemail(email)
{
    if(email.length > 7 && email.includes('@gmail.com'))
    {
        ...
        document.getElementById('email_error').innerText='email must be 8 letter long and consist @gmail.com'
    }
}
...
function checkpassword(password)
{
    if(password.length > 7 && password.includes('.'))
    {
        ...
        document.getElementById('password_error').innerText='password must be 8 letter long and consist . in it'
    }
}
